 ...
 *
 */
class Images_Bootstrap extends Zend_Application_Module_Bootstrap
{
    ...
    protected function _initConfiguration() 
    {
		...
		$images_config = new Zend_Config_Ini($configFile,'images');
		Zend_Registry::set("images_config", $images_config);	
