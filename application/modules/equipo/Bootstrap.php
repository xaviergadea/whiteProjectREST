 ...
 *
 */
class Equipo_Bootstrap extends Zend_Application_Module_Bootstrap
{
    ...
    protected function _initConfiguration() 
    {
		...
		$equipo_config = new Zend_Config_Ini($configFile,'equipo');
		Zend_Registry::set("equipo_config", $equipo_config);	
